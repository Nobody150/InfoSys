...
public class Lagerverwaltung {
	...
	public void lagerbestandAusgeben() {
		...
		for (Lagerposten lposten : lagerposten) {
			...
			System.out.println(LocalDate.now() + " " + "Der Bestand für den Artikel: " + artikel.getID() + " ("
	 ...
	 * verfügungstehen und die Menge vorhanden ist.
	 * 
	 * @param mitarbeiter,
	 *            wird zum überprüfen ob der jeweilige Mitarbeiter recchte zum
	 *            ausführen hat.
	 * @param bestellposten,
